...
import { RemoveAlbumDto } from '../../common/dto/album/remove-album.dto';
import { RemvoeTrackFromAlbumDto } from '../../common/dto/album/remvoe-track-from-album.dto';
import { GetAlbumDto } from '../../common/dto/album/get-album.dto';
import { GetUserAlbumsDto } from '../../common/dto/album/get-user-albums.dto';
...
export class AlbumController {
  ...
  @UseGuards(AuthGuard('jwt'))
  @UsePipes(new ValidationPipe())
  async removeAlbumTrack(@Req() request, @Body() dto: RemvoeTrackFromAlbumDto) {
    const token = request.headers.authorization.replace('Bearer ', '');
